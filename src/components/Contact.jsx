...
const socialLinks = [
  {
    href: 'https://github.com/azalmaan1',
  ...
  {
    href: 'https://www.linkedin.com/in/abdirisak-salman',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: 'https://www.facebook.com/abdirisak.salman',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 2.04C6.48 2.04 2 6.52 2 12.04C2 16.84 5.66 20.74 10.26 21.5V14.89H7.89V12.04H10.26V9.79C10.26 7.44 11.78 6.04 13.88 6.04C14.88 6.04 15.94 6.23 15.94 6.23V8.54H14.79C13.65 8.54 13.26 9.27 13.26 10.01V12.04H15.83L15.43 14.89H13.26V21.5C17.86 20.74 21.52 16.84 21.52 12.04C21.52 6.52 17.04 2.04 12 2.04Z" fill="currentColor" />
    </svg>,
    alt: 'Facebook'
  },
];
  ...
  return (
    ...
    >
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <form
          action="https://getform.io/f/bpjnzlzb"
          method="POST"
